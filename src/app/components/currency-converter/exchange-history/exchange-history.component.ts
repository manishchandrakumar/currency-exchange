...
} from 'src/app/core/services/exchange/interfaces/exchange-history.interface';
...
export class ExchangeHistoryComponent implements OnInit {
  ...
  @Output() exchangeHistoryRequest = new EventEmitter<ExchangeHistoryRequest>();

  selectedDuration = ExchangeConstants.ExchangeHistoryDefaultDuration;
  selectedHistoryType = ExchangeConstants.DefaultHistoryViewType;
  ...
  selectDuration(): void {
    ...
    this.exchangeHistoryRequest.emit({startDate, endDate, from, to});
  }
}
